...
if (isset($_GET['backup_id'])) {
    ...
    $sql = "SELECT backup_id, backup_name, backup_date, backup_time FROM backup WHERE backup_id = '$backup_id'";
...
// Load shops from Db
$sql = "SELECT backup_id, backup_name, backup_date, backup_time FROM backup;";
$result = mysqli_query($conn, $sql);
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Backup Management</a>
                </div>
