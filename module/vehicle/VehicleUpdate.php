        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Update Vehicle</a>
                </div>
...
<br>
<form class="well form-horizontal" action="submitUpdateVehicle.php" method="post" id="" name="myform">

    <input type="hidden" value="<?php echo $_GET['vid'];?>" name="vid">

	<div class="row">
		<div class="col-lg-6">
				<label>Brand : </label><input name="brand" type="text" id="txtBrand" class="form-control"  value="<?php echo $_GET['vbrand'];?>"><br>
		</div>

      <div class="col-lg-6">
      			<label>Model : </label><input name="model" type="text" id="txtModel" class="form-control" value="<?php echo $_GET['vmodel'];?>" ><br>
	  </div>

        <div class="col-lg-6">
            <label>Vehicle Number : </label> <input class="form-control" type="text" placeholder="" id="txtNumber" name="number" value="<?php echo $_GET['vnumber'];?>">
        </div>
	 
    <div class="col-lg-6">
		<label>type : </label> <input class="form-control" type="text" placeholder="" id="txtType" name="type" value="<?php echo $_GET['vtype'];?>">
	</div></div>
			<br><br>
	...
	<div class="col-lg-4">
		<input type="submit" value="Update" class="btn btn-warning btn-block"  id="btnSubmit">
	</div>
