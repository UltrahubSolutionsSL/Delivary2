...
$sqlToFillTable = "SELECT * FROM daily WHERE `date` = '$asAtdate' && `rep_name` = '$repname'; ";
					...
					<div class="container-fluid">
					  ...
					  <div align="right">
						...
						<label>Total : </label> <input type="text" disabled id="txtTotal" align="right">
                              ...
                              <button type="button" class="btn btn-block btn-primary"  onclick="loadReturnMC()"><h4 class="text-center">Add Return Items</h4></button>
...
function btnPayMethod(x){
    ...
    function txtSearchByItemNameMC(txtSearchByItemName){
        ...
        var tbody2 = document.getElementById('tblTbody2');
