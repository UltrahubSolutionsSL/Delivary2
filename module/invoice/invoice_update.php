    ...
    <div class="main-panel">
        ...
        <form name="myform" action="invoice-process.php" method="post" style="padding-left: 15px; padding-right: 15px">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="hidden" name="route" id="txtRoute">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="hidden" name="driver" id="deiver">
                        <input type="hidden" id="driver_name" name="driver_name">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input id="vehicle_no" name="vehicle_no" type="hidden" class="form-control" readonly="readonly">
                    </div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class='btn btn-info btn-xs'
                               href="shop-management.php?shop_no=<?php echo $row['shop_no']; ?>">
