...
<div class="wrapper">
    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            <li>
                <a href="../driver/driver-management.php">
                    <i class="pe-7s-user"></i>  <!------- pe-7s-graph-------------->
                    <p>Representatives</p>
                </a>
            </li>
            <li class="active">
                <a href="stock-management.php">              <!------- pe-7s-user-------------->
        ...
        <li>
            <a href="../backup/backup-management.php">
...
<div class="row col-md-12 col-md-offset-0 custyle">
        ...
        <thead>
            ...
            <tr>
                ...
                <th>Item Name <input type="select" id="txtSearchByName" onKeyUp="txtSearchByNameMC(this)" class="form-control" placeholder="Search Item By Name"></th>
