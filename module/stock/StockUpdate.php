...
<form class="well form-horizontal" action=" " method="post" >
        ...
        <div class="form-group">
          ...
          <input  name="iname" value="<?php echo $_GET['iname'];?>" class="form-control"  type="text">
            </div>
          </div>
        </div>
        ...
        <!-- Text input-->
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-tree-conifer"></i></span>
                        <input  name="des" value="<?php echo $_GET['des'];?>" class="form-control"  type="text">
                    </div>
                </div>
            </div>
       ...
       <div class="form-group">
            ...
            <input name="exd" class="form-control"  type="text" value="<?php echo $_GET['exp'];?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
                ...
                <input  name="qut" value="<?php echo $_GET['quan'];?>" class="form-control"  type="number">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                    ...
                    <input  name="pri" value="<?php echo $_GET['pri'];?>" class="form-control"  type="text">
                      </div>
                    </div>
                  </div>
...
<!-------user add--->
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <button type="submit" class="btn btn-warning" name="btn4">Update <span class="glyphicon glyphicon-send"></span></button>
          </div>
        </div>
        ...
        if(isset($_POST['btn4'])) {
         ...
         $query2="UPDATE `stock` SET `item_name` = '$iname', `description` = '$des', `expire_date` = '$exp', `quantity` = '$qua', `price` = '$pri' WHERE `stock`.`item_code` = '$id'";
         ...
         if($run2){
            ...
            echo "<meta http-equiv='refresh' content='0.1,url=stock-management.php'>";
         }
